...
psql -U postgres -c 'CREATE DATABASE whitelist'
psql -U postgres -d whitelist -c 'CREATE TABLE IF NOT EXISTS whitelists (whitelist_id integer, metadata json, whitelist json, PRIMARY KEY(whitelist_id))'